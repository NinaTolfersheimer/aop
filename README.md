# aop
A Python module that implements the [aop standard v1.0](https://tolfersheim.ddns.net/index.php/s/GabziFRsMD7FLeY) for amateur astronomical observation logs.
...
## How to use
*Note: This is just a simple overview. Check out the proper documentation on [NTI's website](https://ninatolfersheimer.github.io/aop) for technical details.*
